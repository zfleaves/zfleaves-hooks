 ...
 *
 * title: 父组件向子组件共享事件
 * desc: 父组件创建了一个 `focus$` 事件，并且将它传递给了两个子组件。在 MessageBox 中调用 `focus$.emit` ，InputBox 组件就可以收到通知。
 */

import React, { useRef, FC } from 'react';
import { useEventEmitter } from 'zfleaves-hooks';
import { EventEmitter } from 'zfleaves-hooks/lib/useEventEmitter';
